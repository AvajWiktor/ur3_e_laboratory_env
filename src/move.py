...
def add_table():
    ...
    scene.add_box("table", p, (2, 1.4, 0.02))
    p.pose.position.z = 0.65
    scene.add_box("sufit", p, (2, 1.4, 0.02))
    ...
    scene.add_box("right_wall", p, (1.2, 0.02, 0.77))
    ...
    scene.add_box("left_wall", p, (1.2, 0.02, 0.77))
...
def main():
  ...
  try:
	...
	print "0. Go to detect position"
    	...
    	print "3. Go to detected tag (you need to have detected tags)"
	print "3. -> 7 execute whole path"
	print "4. Show markers positions"
	print "5. Add cage"
	print "6. Turn off tool pin 0"
	print "7. Turn on tool pin 0"
